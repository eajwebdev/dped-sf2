        ...
        <x-form-modal create-title="New Teacher" edit-title="Edit Teacher"
            ...
            <div>
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="employee_no" x-model="form.employee_no" class="w-full rounded-lg border border-gray-300 dark:border-white/15 dark:bg-navy-900 text-sm px-4 py-2.5 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all">
                    </div>
                </div>
                <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="email" name="email" x-model="form.email" class="w-full rounded-lg border border-gray-300 dark:border-white/15 dark:bg-navy-900 text-sm px-4 py-2.5 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all">
                    </div>
                    <div>
                        <label class="mb-1.5 block text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-400">Contact</label>
                        <input type="text" name="contact" x-model="form.contact" class="w-full rounded-lg border border-gray-300 dark:border-white/15 dark:bg-navy-900 text-sm px-4 py-2.5 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all">
                    </div>
                </div>
            ...
            <div class="border-t border-gray-200 dark:border-white/10 pt-5">
                ...
                <label class="flex cursor-pointer items-center gap-3">
                    ...
                    <input type="checkbox" name="create_account" value="1" x-model="form.create_account" class="rounded border-gray-300 dark:border-white/15 text-brand-600 focus:ring-brand-500/20">
                ...
                <div x-show="form.create_account" x-cloak class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="email" name="account_email" x-model="form.account_email" class="w-full rounded-lg border border-gray-300 dark:border-white/15 dark:bg-navy-900 text-sm px-4 py-2.5 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all">
                    ...
                    <div>
                        ...
                        <input type="password" name="account_password" x-model="form.account_password" class="w-full rounded-lg border border-gray-300 dark:border-white/15 dark:bg-navy-900 text-sm px-4 py-2.5 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all">
