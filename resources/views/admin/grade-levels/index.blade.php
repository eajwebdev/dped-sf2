                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700/50">
                        @forelse ($gradeLevels as $g)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                ...
                                <td class="px-6 py-4"><code class="rounded-lg bg-gray-100 dark:bg-gray-900 px-2.5 py-1.5 font-mono text-xs text-gray-700 dark:text-gray-300">{{ $g->code }}</code></td>
                                <td class="px-6 py-4">
                                    @if ($g->is_graduating)
        ...
        <x-form-modal create-title="New Grade Level" edit-title="Edit Grade Level"
            ...
            <div>
                ...
                <input type="number" name="level_order" x-model="form.level_order" required min="1" max="20"
                       class="w-full sm:w-40 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-sm px-4 py-2.5 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all">
            ...
            <label class="inline-flex items-center gap-2.5 text-sm">
                <input type="checkbox" name="is_graduating" value="1" x-model="form.is_graduating" class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500/20">
