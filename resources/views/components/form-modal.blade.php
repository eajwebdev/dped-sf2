...
<div x-show="open" x-cloak
    ...
    <div x-show="open"
         ...
         class="w-full {{ $maxWidth }} max-h-[90vh] overflow-y-auto rounded-2xl bg-white dark:bg-gray-800 shadow-2xl">
        <div class="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 dark:border-gray-700 px-6 py-5 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-700">
            ...
            <button type="button" @click="close()" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
        ...
        <form :action="action" method="POST" class="p-6 space-y-4">
            ...
            <div class="flex justify-end gap-3 border-t border-gray-200 dark:border-gray-700 pt-5">
                <button type="button" @click="close()" class="rounded-lg px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">Cancel</button>
                <button type="submit" class="rounded-lg bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-2.5 text-sm font-bold text-white hover:shadow-lg hover:shadow-indigo-500/30 transition-all"
