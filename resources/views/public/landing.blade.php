<x-public-layout title="Automated School Forms System — Automate DepEd School Forms">
    ...
    <section id="features" class="relative py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            @php
                // The adviser-owned DepEd School Forms. SF1, SF2, SF3, SF5, and SF8 ship today;
    ...
    <section id="faq" class="py-24">
        <div class="mx-auto max-w-3xl px-4 sm:px-6">
            ...
            @php
                $faqs = [
                    ['Which School Form modules can I use today?', 'Five are live: SF1 — School Register, SF2 — Daily Attendance, SF3 — Books Issued and Returned, SF5 — Promotion and Level of Proficiency, and SF8 — Learner\'s Basic Health and Nutrition Report, all generated as print-ready PDFs in the official DepEd layout. SF9 and SF10 are in development and clearly marked Coming soon across this page. You are never billed for a module before it is released.'],
